...
void Config::change_language(const LanguageCode& code) { config_["language"] = code.as_string(); }
...
nlohmann::json& Config::operator[](const std::string& key) { return config_[key]; }
