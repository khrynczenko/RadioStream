...
/**
 * Resolve URI i.e. there may exists URIs that point directly to a stream or they could point to the Playlist file
 * such as .m3u or .pls file. This class solves this problem. In case its playlits it downlaods the files, parses it
